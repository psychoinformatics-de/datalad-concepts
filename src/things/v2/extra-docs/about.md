...
The schema documentation contains [an example](/s/things/v2/Thing#example-thing-02-identifiers) showing how this can be done via the `attributes` slot of a `Thing`. For schema development, the [identifiers extension schema](/s/identifiers) is worth a look.
...
See the [example for a topic annotation](/s/things/v2/Thing#example-thing-03-topic) for a concrete demo.
