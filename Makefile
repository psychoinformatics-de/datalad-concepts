...
build/linkml-docs: \
	...
	build/linkml-docs/s/distributions/unreleased
...
check-models: \
	...
	checkmodel/distributions/unreleased
checkmodel/%: src/%.yaml
	@echo [Check $<]
	@echo "Run linter"
	@linkml-lint \
...
check-validation: \
	...
	convertexamples/distributions/unreleased \
	checkvalidation/distributions/unreleased
checkvalidation/%:
